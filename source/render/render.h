...
constexpr int32_t MAXIMUM_RENDERED_DISTANT_LIGHTS = 2;
constexpr int32_t MAXIMUM_RENDERED_POINT_LIGHTS = 2;
constexpr int32_t MAXIMUM_RENDERED_ENVIRONMENT_SURFACES = 16384;
constexpr int32_t MAXIMUM_RENDERED_CLUSTERS = 128;
constexpr int32_t MAXIMUM_SURFACES_PER_STRUCTURE = 131072;
constexpr int32_t MAXIMUM_RENDERED_LIGHTS = 128;
constexpr int32_t MAXIMUM_LIGHTS_PER_MAP = 896;
constexpr int32_t MAXIMUM_LENS_FLARES_PER_LIGHT = 8;
constexpr int32_t MAXIMUM_QUEUED_LENS_FLARES = 8;
