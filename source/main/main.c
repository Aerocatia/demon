...
//constexpr int32_t SAFE_TO_SAVE_RETRY_TIME = TICKS_PER_SECOND / 3;
//constexpr int32_t SAFE_TO_SAVE_MAXIMUM_TIME = 8 * TICKS_PER_SECOND;
//constexpr int32_t SAFE_TO_SAVE_MINIMUM_INTERVALS = 3;
constexpr int32_t VBLANK_MAXIMUM_SKIP_RATE = 5;
//constexpr int32_t VBLANK_FAILURE_FRAME_COUNT = 4;
//constexpr int32_t VBLANK_RESUME_INTERVAL = 15;
constexpr int32_t VBLANK_FLIP_DELTA_COUNT = 15;
//constexpr int32_t MAIN_MENU_FADE_TIME_MILLISECONDS = 1 * MILLISECONDS_PER_SECOND;
//constexpr int32_t INTERESTING_TIMEOUT_LOCK = 10 * MILLISECONDS_PER_SECOND;
//constexpr int32_t MAIN_LOSS_LATENCY = 90;
