...
constexpr int32_t MAXIMUM_BSP2D_REFERENCES_PER_COLLISION_BSP = 131072;
constexpr int32_t MAXIMUM_SURFACES_PER_COLLISION_BSP = 131072;
constexpr int32_t MAXIMUM_EDGES_PER_COLLISION_BSP = 262144;
constexpr int32_t MAXIMUM_VERTICES_PER_COLLISION_BSP = 131072;
constexpr int32_t MAXIMUM_VERTICES_PER_COLLISION_SURFACE = 8;
constexpr int32_t MAXIMUM_EDGES_PER_COLLISION_SURFACE = MAXIMUM_VERTICES_PER_COLLISION_SURFACE;
