...
constexpr tag STRUCTURE_BSP_TAG = 0x73627370;
constexpr int16_t STRUCTURE_BSP_VERSION = 5;

constexpr int32_t MAXIMUM_COLLISION_MATERIALS_PER_STRUCTURE = 512;
constexpr int32_t MAXIMUM_SURFACE_REFERENCES_PER_STRUCTURE = 256 * KIB;
constexpr int32_t MAXIMUM_LIGHTMAPS_PER_STRUCTURE = 128;
constexpr int32_t MAXIMUM_MATERIALS_PER_STRUCTURE_LIGHTMAP = 2 * KIB;
constexpr int32_t MAXIMUM_SURFACES_PER_STRUCTURE_MATERIAL = 20000;
constexpr int32_t MAXIMUM_VERTICES_PER_STRUCTURE_MATERIAL = 64000;
constexpr int32_t MAXIMUM_CLUSTER_PORTALS_PER_CLUSTER = 128;
constexpr int32_t MAXIMUM_MIRRORS_PER_CLUSTER = 16;
constexpr int32_t MAXIMUM_SUBCLUSTERS_PER_CLUSTER = 4096;
constexpr int32_t MAXIMUM_SURFACES_PER_SUBCLUSTER = 128;
constexpr int32_t MAXIMUM_SURFACES_PER_CLUSTER = 32 * KIB;
constexpr int32_t MAXIMUM_VERTICES_PER_MIRROR = 512;
constexpr int32_t MAXIMUM_TEMPORARY_CLUSTERS_PER_STRUCTURE = 8 * KIB;
constexpr int32_t MAXIMUM_CLUSTERS_PER_STRUCTURE = 512;
constexpr int32_t MAXIMUM_CLUSTER_DATA_SIZE = 65536;
constexpr int32_t MAXIMUM_CLUSTER_PORTALS_PER_STRUCTURE = 512;
constexpr int32_t MAXIMUM_VERTICES_PER_CLUSTER_PORTAL = 128;
constexpr int32_t MAXIMUM_FOG_PLANES_PER_STRUCTURE = 32;
constexpr int32_t MAXIMUM_VERTICES_PER_STRUCTURE_FOG_PLANE = 4 * KIB;
constexpr int32_t MAXIMUM_FOG_REGIONS_PER_STRUCTURE = 32;
constexpr int32_t MAXIMUM_FOG_PALETTE_ENTRIES_PER_STRUCTURE = 32;
constexpr int32_t MAXIMUM_WEATHER_PALETTE_ENTRIES_PER_STRUCTURE = 32;
constexpr int32_t MAXIMUM_WEATHER_POLYHEDRA_PER_STRUCTURE = 32;
constexpr int32_t MAXIMUM_PLANES_PER_WEATHER_POLYHEDRON = 16;
constexpr int32_t MAXIMUM_BACKGROUND_SOUND_PALETTE_ENTRIES_PER_STRUCTURE = 64;
constexpr int32_t MAXIMUM_SOUND_ENVIRONMENT_PALETTE_ENTRIES_PER_STRUCTURE = 64;
constexpr int32_t MAXIMUM_MARKERS_PER_STRUCTURE = 1 * KIB;
constexpr int32_t MAXIMUM_LENS_FLARES_PER_STRUCTURE = 256;
constexpr int32_t MAXIMUM_LENS_FLARE_MARKERS_PER_STRUCTURE = 64 * KIB;
constexpr int32_t MAXIMUM_DECALS_PER_STRUCTURE = 6 * KIB;

constexpr real MAXIMUM_ENCODED_SOUND_DISTANCE = 256.0f;
