...
enum {
    ...
    MAXIMUM_SURFACE_REFERENCES_PER_STRUCTURE = 256 * KILO,
    MAXIMUM_LIGHTMAPS_PER_STRUCTURE = 128,
    MAXIMUM_MATERIALS_PER_STRUCTURE_LIGHTMAP = 2 * KILO,
    ...
    MAXIMUM_SURFACES_PER_CLUSTER = 32 * KILO,
    MAXIMUM_VERTICES_PER_MIRROR = 512,
    MAXIMUM_TEMPORARY_CLUSTERS_PER_STRUCTURE = 8 * KILO,
    ...
    MAXIMUM_VERTICES_PER_STRUCTURE_FOG_PLANE = 4 * KILO,
    ...
    MAXIMUM_MARKERS_PER_STRUCTURE = 1 * KILO,
    MAXIMUM_LENS_FLARES_PER_STRUCTURE = 256,
    MAXIMUM_LENS_FLARE_MARKERS_PER_STRUCTURE = 64 * KILO,
    MAXIMUM_DECALS_PER_STRUCTURE = 6 * KILO,
};
