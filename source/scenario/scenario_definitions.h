...
constexpr tag SCENARIO_GROUP_TAG = 0x73636E72; // 'scnr'
constexpr tag SCENARIO_CUSTOM_DECAL_ID = 0x626C6168; // 'blah'

constexpr int16_t SCENARIO_VERSION = 2;

constexpr int32_t MAXIMUM_SCENARIO_PLAYERS_PER_BLOCK = 256;
constexpr int32_t MAXIMUM_TRIGGER_VOLUMES_PER_SCENARIO = 256;
constexpr int32_t MAXIMUM_FUNCTIONS_PER_SCENARIO = 32;
constexpr int32_t MAXIMUM_OBJECT_NAMES_PER_SCENARIO = 512;
constexpr int32_t MAXIMUM_DEVICE_GROUPS_PER_SCENARIO = 128;
constexpr int32_t MAXIMUM_SCENARIO_OBJECT_PALETTE_ENTRIES_PER_BLOCK = 100;
constexpr int32_t MAXIMUM_CUTSCENE_FLAGS_PER_SCENARIO = 512;
constexpr int32_t MAXIMUM_CUTSCENE_CAMERA_POINTS_PER_SCENARIO = 512;
constexpr int32_t MAXIMUM_CUTSCENE_TITLES_PER_SCENARIO = 64;
constexpr int32_t MAXIMUM_SCENARIO_NETGAME_FLAGS_PER_SCENARIO = 200;
constexpr int32_t MAXIMUM_SCENARIO_NETGAME_EQUIPMENT_PER_SCENARIO = 200;
constexpr int32_t MAXIMUM_SCENARIO_STARTING_EQUIPMDNG_PER_SCENARIO = 200;
constexpr int32_t MAXIMUM_STRUCTURE_BSPS_PER_SCENARIO = 16;
constexpr int32_t MAXIMUM_CHILD_SCENARIOS_PER_SCENARIO = 16;
constexpr int32_t MAXIMUM_SKIES_PER_SCENARIO = 8;
constexpr int32_t MAXIMUM_DECALS_PER_SCENARIO = 64 * KIB;
constexpr int32_t MAXIMUM_DECAL_PALETTES_PER_SCENARIO = 128;
constexpr int32_t MAXIMUM_SCENERY_DATUMS_PER_SCENARIO = 2000;
constexpr int32_t MAXIMUM_SOUND_SCENERY_DATUMS_PER_SCENARIO = 256;
constexpr int32_t MAXIMUM_WEAPON_DATUMS_PER_SCENARIO = 128;
constexpr int32_t MAXIMUM_EQUIPMENT_DATUMS_PER_SCENARIO = 256;
constexpr int32_t MAXIMUM_BIPED_DATUMS_PER_SCENARIO = 128;
constexpr int32_t MAXIMUM_VEHICLE_DATUMS_PER_SCENARIO = 80;
constexpr int32_t MAXIMUM_MACHINE_DATUMS_PER_SCENARIO = 400;
constexpr int32_t MAXIMUM_CONTROL_DATUMS_PER_SCENARIO = 100;
constexpr int32_t MAXIMUM_LIGHT_FIXTURE_DATUMS_PER_SCENARIO = 500;
constexpr int32_t MAXIMUM_EDITOR_SCENARIO_DATA_SIZE = 64 * KIB;
constexpr int32_t MAXIMUM_EDITOR_COMMENTS = KIB;
constexpr int32_t MAXIMUM_EDITOR_COMMENT_LENGTH = 16 * KIB;
