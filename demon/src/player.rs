...
pub unsafe fn get_local_player_id() -> PlayerID {
    local_player_index_to_id(*LOCAL_PLAYER_INDEX.get())
}

pub unsafe fn local_player_index_to_id(local_player_index: u16) -> PlayerID {
    if local_player_index == 0xFFFF {
        return PlayerID::NULL
    }
    get_player_id(local_player_index)
}
